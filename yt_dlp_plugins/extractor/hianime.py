...
class HiAnimeIE(InfoExtractor):
    _VALID_URL = r'https?://hianime(?:z)?\.(?:ms|to|is|nz|bz|pe|cx|gs|do)/(?:watch/)?(?P<slug>[^/?]+)(?:-\d+)?-(?P<playlist_id>\d+)(?:\?ep=(?P<episode_id>\d+))?$'

    _TESTS = [
        {
            'url': 'https://hianime.ms/demon-slayer-kimetsu-no-yaiba-hashira-training-arc-19107',
            'info_dict': {
                'id': '19107',
        ...
        {
            'url': 'https://hianime.ms/watch/demon-slayer-kimetsu-no-yaiba-hashira-training-arc-19107?ep=124260',
            'info_dict': {
                'id': '124260',
        ...
        {
            'url': 'https://hianime.ms/the-eminence-in-shadow-17473',
            'info_dict': {
                'id': '17473',
        ...
        {
            'url': 'https://hianime.ms/watch/the-eminence-in-shadow-17473?ep=94440',
            'info_dict': {
                'id': '94440',
